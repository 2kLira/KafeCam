    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section {
                    Link(destination: URL(string: "https://kafecam.app/privacy")!) {
                        Label("Política de privacidad", systemImage: "hand.raised.fill").foregroundStyle(accentColor)
                    }
                    Link(destination: URL(string: "https://kafecam.app/terms")!) {
                        Label("Términos de servicio", systemImage: "doc.text.fill").foregroundStyle(accentColor)
                    }
                } header: {
                    Text("Legal").foregroundStyle(accentColor)
                }

                // MARK: - ZONA DE PELIGRO (eliminar cuenta)
                Section {
                    NavigationLink {
                        DeleteAccountView()
                    } label: {
